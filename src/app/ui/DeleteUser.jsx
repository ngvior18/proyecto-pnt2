...
export default function DeleteUser() {
    ...
    const handleDeleteCategorie = () => {
        ...
        const url = `http://localhost:3000/api/usuarios/deleteUsuarios/${inputValueDelete}`;
        ...
        <>
            <div className="deleteCategorie actionCrud">
                ...
                <div className="titleCrud">
                    <button className="buttonCrud" onClick={handleDeleteCategorie}>Eliminar usuario</button>
                </div>
            </div>
        </>
    )
