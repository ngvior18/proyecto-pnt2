        ...
        <><header className="isolate border-b border-white-100">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
                ...
                <PopoverGroup className="hidden lg:flex">
                        ...
                        >
                           ...
                           <div className="p-4">
                                        {categorias.map((categoria) => (
                                            <div key={categoria._id} className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-cyan-700">
                                                <a href="#" className="block font-semibold text-gray-900 font-cambria">
                                                    {categoria.nombre}
                    ...
                    <a href="/contacto" className="text-sm font-semibold leading-6 text-white p-2 px-4 transition-colors font-cambria">
                        CONTACTANOS
                    </a>
                    <a href="#" className="text-sm font-semibold leading-6 text-white p-2 px-4 transition-colors font-cambria">
                        MIS PEDIDOS
                    </a>
                    <a href="#" className="text-sm font-semibold rounded-lg leading-6 text-white p-2 px-4 transition-colors font-cambria">
                        ARMA TU PC
                    </a>
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end items-center">
                    ...
                    <a href="#" className="ml-4 text-sm font-semibold leading-6 text-cyan-700 p-1 border border-transparent rounded-lg hover:border-white transition-colors">
